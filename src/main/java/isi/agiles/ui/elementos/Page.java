...
public class Page<T> {
    private SimpleIntegerProperty totalRecord; // Tamaño total de los datos
    private SimpleIntegerProperty pageSize; // Cantidad de filas por pagina
    private SimpleIntegerProperty totalPage; // Cantidad de paginas
    private List<T> rowDataList; // Datos de la tabla
